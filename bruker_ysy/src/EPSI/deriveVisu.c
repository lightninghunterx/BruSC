  ...
  {  
      ...
      */
      if (ParxRelsParHasValue("PVM_EpiNEchoes"))
          ...
          if (ParxRelsParHasValue("ACQ_jobs") && 
              ParxRelsParHasValue("PVM_EncMatrix") && 0.0 < ACQ_jobs[0].swh)
	    VisuAcqPixelBandwidth = ACQ_jobs[0].swh/(double)PVM_EncMatrix[0];
  }

  if (ParxRelsParHasValue("SpecBandPpm") && 0.0 < SpecBandPpm)
    VisuCoreExtent[1] = SpecBandPpm; 
  strcpy(VisuCoreUnits[1],"ppm");
