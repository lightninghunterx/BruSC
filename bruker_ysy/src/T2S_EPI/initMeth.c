...
/*:=MPE=:=======================================================*/
{
  ...
  if(ParxRelsParHasValue("FirstGradientEchoTime") == No)
    FirstGradientEchoTime = 0;

  /* EchoTimeIncrement: Time between successive echo images */
  ...
  ParxRelsShowInEditor("PVM_EchoTime,PVM_NEchoImages,EchoTimeIncrement,SinglePhaseCorrection");
  ParxRelsShowInFile("PVM_EchoTime,PVM_NEchoImages,EchoTimeIncrement,SinglePhaseCorrection");
