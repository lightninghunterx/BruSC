...
static const char resid[] = "$Id$ (C) 1999-2018 Bruker BioSpin MRI GmbH";
...
/*:=MPE=:=======================================================*/
{
  ...
  STB_InitRFPulse("ExcPul",        // name of pulse structure
                  ...
                  "Calculated", //CFG_RFPulseDefaultShapename(LIB_EXCITATION), // default shape
  ...
  STB_InitRFPulse("RefPul",        // name of pulse structure
                  ...
                  "Calculated", //CFG_RFPulseDefaultShapename(LIB_REFOCUS), // default shape
                  2000.0,          // default bandwidth
  ...
  /* other parameters */
  if(ParxRelsParHasValue("SinglePhaseCorrection") == No)
    SinglePhaseCorrection = Yes;
  ...
  /* init echo time */
  if(ParxRelsParHasValue("SpinEchoTime") == No)
    SpinEchoTime = 35; 
  ...
  ParxRelsShowInEditor("PVM_EchoTime,PVM_NEchoImages,SinglePhaseCorrection");
  ParxRelsShowInFile("PVM_EchoTime,PVM_NEchoImages,SinglePhaseCorrection");
