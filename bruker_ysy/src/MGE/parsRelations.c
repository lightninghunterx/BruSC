...
void EchoAcqModeRange(void)
{
  DB_MSG(("-->EchoAcqModeRange"));

  if(ParxRelsParHasValue("EchoAcqMode")==No)
    EchoAcqMode = allEchoes;

  switch(EchoAcqMode)
  {
  case allEchoes:
    break;
  case positiveReadOutEchoes:
    break;
  default:
    EchoAcqMode = allEchoes;
    break;
...
void EchoAcqModeRel(void)
{
  DB_MSG(("-->EchoAcqModeRel"));
