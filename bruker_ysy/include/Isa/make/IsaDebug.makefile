...
CCLDOPTIONS	= $(CC_EXEC_PREFIX_OPTION) $(PT_GNU_RELRO) $(PV_COMPILE_FLAGS) $(NO_LINKTIME_OPTIMIZE) $(COMMON_FLAG) -fno-gnu-unique -fexceptions $(LINK_OPTIONS)

STATICLIBGCC	= -static-libgcc

LDDEBUGFLAGS	= DebuggableLdDebugFlags
...
CPLUSPLUSLDOPTIONS	= $(CC_EXEC_PREFIX_OPTION) $(PT_GNU_RELRO) $(PV_COMPILE_FLAGS) $(NO_LINKTIME_OPTIMIZE) $(COMMON_FLAG) -fno-gnu-unique -fexceptions $(LINK_OPTIONS)
