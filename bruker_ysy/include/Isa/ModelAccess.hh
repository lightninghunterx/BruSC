...
//
// $Source$
// Convenience shortcuts for accessing ModelBase member.
//
// Copyright (c) 2015
//
 ...
 */
     ...
     */
    void setDescription(const char* shortDescription,
            const char* description) {
        b_.setDescription(shortDescription, description);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    void setIsaVariable(const char* variable) {
        b_.setIsaVariable(variable);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    void setIsaVariableUnit(const char* unit) {
        b_.setIsaVariableUnit(unit);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    void setIsaFrameGroup(const char* frameGroupName) {
        b_.setIsaFrameGroup(frameGroupName);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    void setAbscissaLabel(const char* abscissaLabel) {
        b_.setAbscissaLabel(abscissaLabel);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    void setAbscissaRange(double min, double max,
            bool isMinRelative = false, bool isMaxRelative = false) {
        b_.setAbscissaRange(min, max, isMinRelative, isMaxRelative);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    void setOrdinateLabel(const char* ordinateLabel) {
        b_.setOrdinateLabel(ordinateLabel);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    void setOrdinateUnit(const char* ordinateLabel) {
        b_.setOrdinateUnit(ordinateLabel);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    double getAbscissaRangeMin() {
        return b_.getAbscissaRangeMin();
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    double getAbscissaRangeMax() {
        return b_.getAbscissaRangeMax();
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    void setAuxiliaryROI(const char* auxRoiName, bool sameSlice) {
        b_.setAuxiliaryROI(auxRoiName, sameSlice);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    void require(bool requirement, const char* errorMsg = "") {
        b_.require(requirement, errorMsg);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    bool createdByMRmethod(const char* methodName, bool strict) {
        return b_.createdByMRmethod(methodName, strict);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    int lenFrameGroup(const char* frameGroupName) {
        return b_.lenFrameGroup(frameGroupName);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    bool hasParxValue(const char* parxParameterName) {
        return b_.hasParxValue(parxParameterName);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    std::string PARX_get_string(const char* parameterName) {
        return b_.PARX_get_string(parameterName);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    int numTotal2dFrames() {
        return b_.numTotal2dFrames();
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    const char* getProcnoPath() {
        return b_.getProcnoPath();
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    bool isSuitableForDataset() {
        return b_.isSuitableForDataset();
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    void setParamName(unsigned int paramIndex, const char* name,
            const char* desc = "", const char* unit = "") {
        b_.setParamName(paramIndex, name, desc, unit);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    void setParamDefault(unsigned int paramIndex, double value) {
        b_.setParamDefault(paramIndex, value);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    void setParamValue(unsigned int paramIndex, double value) {
        b_.setParamValue(paramIndex, value);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    void setParamDerivative(unsigned int paramIndex, double value) {
        b_.setParamDerivative(paramIndex, value);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    void setParamOutputOnly(unsigned int paramIndex, bool isOutputOnly) {
        b_.setParamOutputOnly(paramIndex, isOutputOnly);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    void setParamFixed(unsigned int paramIndex, bool isFixed) {
        b_.setParamFixed(paramIndex, isFixed);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    void setParamLowerBound(unsigned int paramIndex, double value) {
        b_.setParamLowerBound(paramIndex, value);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    void setParamUpperBound(unsigned int paramIndex, double value) {
        b_.setParamUpperBound(paramIndex, value);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    void setParamValueAndBounds(unsigned int paramIndex,
            double lowerBound, double value, double upperBound) {
        b_.setParamValueAndBounds(paramIndex, lowerBound, value, upperBound);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    void setDefaultDisplayParam(unsigned int paramIndex) {
        b_.setDefaultDisplayParam(paramIndex);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    const char* getParamName(unsigned int paramIndex) {
        return b_.getParamName(paramIndex);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    const char* getParamDesc(unsigned int paramIndex) {
        return b_.getParamDesc(paramIndex);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    const char* getParamUnit(unsigned int paramIndex) {
        return b_.getParamUnit(paramIndex);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    double getParamDefault(unsigned int paramIndex) {
        return b_.getParamDefault(paramIndex);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    double getParamValue(unsigned int paramIndex) {
        return b_.getParamValue(paramIndex);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    bool getParamOutputOnly(unsigned int paramIndex) {
        return b_.getParamOutputOnly(paramIndex);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    bool getParamFixed(unsigned int paramIndex) {
        return b_.getParamFixed(paramIndex);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    unsigned int getNumDataPoints(bool uniqueAbscVals = false) {
        return b_.getNumDataPoints(uniqueAbscVals);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    std::vector<double> getDataValues(bool onlyActive = false) {
        return b_.getDataValues(onlyActive);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    std::vector<double> getSortedDataValues(bool onlyActive = false) {
        return b_.getSortedDataValues(onlyActive);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    double getDataValue(unsigned int abscissaIndex) {
        return b_.getDataValue(abscissaIndex);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    std::vector<double> getDataSTDs(bool onlyActive = false) {
        return b_.getDataSTDs(onlyActive);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    std::vector<double> getSortedDataSTDs(bool onlyActive = false) {
        return b_.getSortedDataSTDs(onlyActive);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    double getDataSTD(unsigned int abscissaIndex) {
        return b_.getDataSTD(abscissaIndex);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    std::vector<double> getAuxiliaryROIValues(const char* auxRoiName) {
        return b_.getAuxiliaryROIValues(auxRoiName);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    std::vector<double> getAuxiliaryROISTDs(const char* auxRoiName) {
        return b_.getAuxiliaryROISTDs(auxRoiName);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    double getAbscissaValue(unsigned int abscissaIndex) {
        return b_.getAbscissaValue(abscissaIndex);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    std::vector<double> getAbscissaValues(bool onlyActive = false) {
        return b_.getAbscissaValues(onlyActive);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    double getSortedAbscissaValue(unsigned int sortedAbscissaIndex) {
        return b_.getSortedAbscissaValue(sortedAbscissaIndex);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    std::vector<double> getSortedAbscissaValues(bool onlyActive = false) {
        return b_.getSortedAbscissaValues(onlyActive);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    void setAbscissaValues(const std::vector<double>& abscissaValues) {
        b_.setAbscissaValues(abscissaValues);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    void setDataValues(const std::vector<double>& dataValues) {
        b_.setDataValues(dataValues);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    void setDataSTDs(const std::vector<double>& dataSTDs) {
        b_.setDataSTDs(dataSTDs);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    unsigned int getNumActiveDataPoints() {
        return b_.getNumActiveDataPoints();
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    bool getDataPointActive(unsigned int abscissaIndex) {
        return b_.getDataPointActive(abscissaIndex);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    std::vector<bool> getDataPointsActive() {
        return b_.getDataPointsActive();
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    void setDataPointActive(unsigned int abscissaIndex, bool active) {
        b_.setDataPointActive(abscissaIndex, active);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    std::vector<double> getFitParametersValue() {
        return b_.getFitParametersValue();
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    std::vector<double> getFitParametersSTD() {
        return b_.getFitParametersSTD();
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    void setTargetTolerance(double targetTolerance) {
        b_.setTargetTolerance(targetTolerance);
    }
    ...
    void setMaxIterations(unsigned int maxIterations) {
        b_.setMaxIterations(maxIterations);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    void setSaveFixedParams(bool saveFixedParams) {
        b_.setSaveFixedParams(saveFixedParams);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    void setReinitParams(bool reinitParams) {
        b_.setReinitParams(reinitParams);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    void setBypassFit(bool bypassFit) {
        b_.setBypassFit(bypassFit);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    void setBypassEval(bool bypassEval) {
        b_.setBypassEval(bypassEval);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    void setParMapsDependOnROI(bool depends) {
        b_.setParMapsDependOnROI(depends);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    void setBgBestFrame(double bgBestFrame) {
        b_.setBgBestFrame(bgBestFrame);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    double getLinearInterpolation(double x) {
        return b_.getLinearInterpolation(x);
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    bool getReinitParams() {
        return b_.getReinitParams();
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    bool getParMapsDependOnROI() {
        return b_.getParMapsDependOnROI();
    }
     ...
     * @ingroup ISA_MODEL_BASE
     */
    bool callMRmethod(const char* request = "") {
        return b_.callMRmethod(request);
    }
