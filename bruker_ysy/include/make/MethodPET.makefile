...
STD_PT_METHOD_LIBS = \
$(SHLIBDIR)/libPvPtTools$(SHARELIBEXT) \
$(SHLIBDIR)/libPvAcqToolsPt$(SHARELIBEXT) \
$(SHLIBDIR)/libPvCfgToolsPt$(SHARELIBEXT) \
$(SHLIBDIR)/libPvOvlToolsPt$(SHARELIBEXT) \
$(SHLIBDIR)/libPvCfgPT$(SHARELIBEXT) \
$(SHLIBDIR)/libPvGenericServer2MgrCommon$(SHARELIBEXT) \
$(SHLIBDIR)/libPvGenericServer2MgrPt$(SHARELIBEXT) $(STD_COMMON_METHOD_LIBS)
