...
STD_MPI_METHOD_LIBS  = \
$(SHLIBDIR)/libMpiSimulation$(SHARELIBEXT) \
$(SHLIBDIR)/libPvMpiTools$(SHARELIBEXT) \
$(SHLIBDIR)/libPvCfgToolsMpi$(SHARELIBEXT) \
$(SHLIBDIR)/libPvAcqToolsMpi$(SHARELIBEXT) \
$(SHLIBDIR)/libMpiUtil$(SHARELIBEXT) \
$(SHLIBDIR)/libMpiCalibrationDatabase$(SHARELIBEXT) $(STD_MXI_METHOD_LIBS)
