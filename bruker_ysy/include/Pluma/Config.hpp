...
//
// Change by ParaVision team, Bruker BioSpin MRI GmbH:
// - Changed to allow extensions with multiple dots.
//
////////////////////////////////////////////////////////////
...
//
// Changed to use gcc symbol visibility by ParaVision team, 
...
////////////////////////////////////////////////////////////
     ...
     #define PLUMA_LIB_EXTENSION "64.dll"
...
#elif defined(PLUMA_SYS_MACOS)
     #define PLUMA_LIB_EXTENSION "32.dylib"
#elif defined(PLUMA_SYS_LINUX) || defined(PLUMA_SYS_FREEBSD)
     #define PLUMA_LIB_EXTENSION "32.so"
#else
   // unknown library file type
    #error Unknown library file extension for this operating system
#endif
...
////////////////////////////////////////////////////////////
    ...
    // gcc > 4 visibility option.
    #define PLUMA_API  __attribute__ ((visibility("default")))
