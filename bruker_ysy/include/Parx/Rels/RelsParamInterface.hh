//===============================================================
//
// libParxRels implementation of common parameter interface.
//
...
#ifndef PARX_RELS_RELSINTERFACE_HH
#define PARX_RELS_RELSINTERFACE_HH
...
//---------------------------------------------------------------
// interface of class RelsParamInterface
//---------------------------------------------------------------
...
namespace Parx
{
    namespace Relation
    {
        ...
        /** Implementation of  common parameter interface using 
            libParxRels functions.
         */
        class DLL_INTERFACE RelsParamInterface : public Parx::Common::ParamInterface
        {
        public:
            /// Constructor. 
            RelsParamInterface();
             ...
             */
            virtual bool hasValue(const char * param) const;
            ...
            virtual void setParVisibleInFileFlag(
                const std::vector<std::string> & list, bool flag) const;
            ...
            virtual void setParVisibleInEditorFlag(
                const std::vector<std::string> & list, bool visFlag) const;
            ...
            virtual void setGroupEditFlag(
                const std::vector<std::string> & list, bool editFlag) const;
        ...
        private:
            friend class RelsParSpace;

            Parx::Base::BaseParamInterface & getBase() const; 
            
            RelsParamInterface(const RelsParamInterface &) = delete;
            
            /// Deleted assignment operator.
            RelsParamInterface & operator=(const RelsParamInterface &) = delete;
